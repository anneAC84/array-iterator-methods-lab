...
veryOldInventors = inventors.filter(inventors => inventors.year <= 1599)
...
let inventorNames = inventors.map(function(inventors) {
...
// Enter your solution code here:
let sortedByBirthYear = inventors.sort(inventors => inventors.year)
